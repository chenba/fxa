...
connect-another-fx-mobile = Get { -product-firefox } on mobile or tablet
connect-another-find-fx-mobile = Find { -product-firefox } in the { -google-play } and { -app-store } or
...
cs-disconnect-suspicious-advice-content = If the disconnected device is indeed
  suspicious, to keep your information safe, you should change your { -brand-firefox }
